"""
Tianji Horse Racing Optimization
================================
"""
...
class TianjiHorseRacingOptimization(BaseOptimizer):
    """
    Tianji Horse Racing Optimization
    """
    ...
    def __init__(self, population_size=30, max_iterations=100):
        ...
        self.algorithm_name = "Tianji Horse Racing Optimization"
        self.aliases = ["thro", "thro_optimization"]
